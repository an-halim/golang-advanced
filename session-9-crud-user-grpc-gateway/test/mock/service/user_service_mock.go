...
import (
	...
	entity "github.com/an-halim/golang-advanced/session-9-crud-user-grpc-gateway/entity"
...
func (m *MockIUserService) GetAllUsers(ctx context.Context, pageSize, page int) ([]entity.User, error) {
	m.ctrl.T.Helper()
