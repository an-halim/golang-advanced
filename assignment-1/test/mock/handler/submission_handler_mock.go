...
func (m *MockISubmissionHandler) GetAllSubmission(c *gin.Context) {
	m.ctrl.T.Helper()
	m.ctrl.Call(m, "GetAllSubmission", c)
}

// GetAllSubmission indicates an expected call of GetAllSubmission.
func (mr *MockISubmissionHandlerMockRecorder) GetAllSubmission(c interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllSubmission", reflect.TypeOf((*MockISubmissionHandler)(nil).GetAllSubmission), c)
}
