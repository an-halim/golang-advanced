...
func (m *MockIUserService) CreateUser(ctx context.Context, request request.CreateUserRequest) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserServiceMockRecorder) CreateUser(ctx, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateUser", reflect.TypeOf((*MockIUserService)(nil).CreateUser), ctx, request)
}
...
func (m *MockIUserService) GetAllUsers(ctx context.Context, pageSize, page int) ([]response.ResponseSubmissionInfo, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUsers", ctx, pageSize, page)
	ret0, _ := ret[0].([]response.ResponseSubmissionInfo)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}

// GetAllUsers indicates an expected call of GetAllUsers.
func (mr *MockIUserServiceMockRecorder) GetAllUsers(ctx, pageSize, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUsers", reflect.TypeOf((*MockIUserService)(nil).GetAllUsers), ctx, pageSize, page)
}

// GetUserByID mocks base method.
func (m *MockIUserService) GetUserByID(ctx context.Context, id int) (response.ResponseSubmissionInfo, error) {
	m.ctrl.T.Helper()
...
func (m *MockIUserService) UpdateUser(ctx context.Context, id int, request request.UpdateUserRequest) (int, error) {
	m.ctrl.T.Helper()
...
func (mr *MockIUserServiceMockRecorder) UpdateUser(ctx, id, request interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "UpdateUser", reflect.TypeOf((*MockIUserService)(nil).UpdateUser), ctx, id, request)
}
...
// GetAllUsers mocks base method.
func (m *MockIUserRepository) GetAllUsers(ctx context.Context, pageSize, page int) ([]entity.User, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetAllUsers", ctx, pageSize, page)
	ret0, _ := ret[0].([]entity.User)
	ret1, _ := ret[1].(error)
...
// GetAllUsers indicates an expected call of GetAllUsers.
func (mr *MockIUserRepositoryMockRecorder) GetAllUsers(ctx, pageSize, page interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "GetAllUsers", reflect.TypeOf((*MockIUserRepository)(nil).GetAllUsers), ctx, pageSize, page)
}
