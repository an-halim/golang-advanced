...
import (
	...
	"github.com/an-halim/golang-advanced/session-9-crud-user-grpc/entity"
	"github.com/an-halim/golang-advanced/session-9-crud-user-grpc/handler"
	"github.com/an-halim/golang-advanced/session-9-crud-user-grpc/response"
	"github.com/stretchr/testify/require"

	mock_service "github.com/an-halim/golang-advanced/session-9-crud-user-grpc/test/mock/service"
...
func TestUserHandler_CreateUser(t *testing.T) {
	...
	t.Run("ValidRequest", func(t *testing.T) {
		...
		require.JSONEq(t, `{"status": "success","message": "User created successfully","data": {"id":0,"name":"John Doe","email":"john@example.com","password":"password","created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"}}`, resp.Body.String())
	})
	...
	t.Run("InvalidPayload_MissingName", func(t *testing.T) {
		...
		var respActual response.Failed
		json.Unmarshal(resp.Body.Bytes(), &respActual)
		require.Equal(t, expected, respActual)
	})
...
func TestUserHandler_GetUser(t *testing.T) {
	...
	t.Run("ValidRequest", func(t *testing.T) {
		...
		require.JSONEq(t, `{"status": "success","message": "User found","data": {"id":1,"name":"John Doe","email":"john@example.com","password":"","created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"}}`, resp.Body.String())
	})
...
func TestUserHandler_UpdateUser(t *testing.T) {
	...
	t.Run("ValidRequest", func(t *testing.T) {
		...
		require.Equal(t, http.StatusOK, resp.Code)
		require.JSONEq(t, `{"status": "success","message": "User updated successfully","data": {"id":1,"name":"John Doe","email":"john@example.com","password":"","created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"}}`, resp.Body.String())
	})
...
func TestUserHandler_DeleteUser(t *testing.T) {
	...
	t.Run("ValidRequest", func(t *testing.T) {
		...
		var respActual response.Success
		json.Unmarshal(resp.Body.Bytes(), &respActual)
		require.Equal(t, expected, respActual)
	})
...
func TestUserHandler_GetAllUsers(t *testing.T) {
	...
	t.Run("ValidRequest", func(t *testing.T) {
		...
		require.Equal(t, http.StatusOK, resp.Code)
		require.JSONEq(t, `{"status": "success","data": [{"id":1,"name":"John Doe","email":"john@example.com","password":"","created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"},{"id":2,"name":"Jane Doe","email":"jane@example.com","password":"","created_at":"0001-01-01T00:00:00Z","updated_at":"0001-01-01T00:00:00Z"}],"page_size": 0,"current_page": 1}`, resp.Body.String())
	})
